...
This test aims to evaluate the dependency on parameters, ie to evaluate the correlation between the presence of the biomarkers and the presence of cancer.
